...
def main():
    ...
    if os.path.isfile('./music_game_score_model.h5') is False:
        print('create models')
        ...
        imgs_test = imgs_test.astype('float32') / 255.0
        labels_test = np_utils.to_categorical(labels_test, len(dir_names))    # one-hot形式に変換
